...
getCarById() {
  ...
  this.updateForm.patchValue({
    ...
    year: new Date(carDto.year), // Convert year string to Date object
  });
})
...
// Only include year if the user has changed it and the form exists
if (this.updateForm?.get('year')?.dirty) {
